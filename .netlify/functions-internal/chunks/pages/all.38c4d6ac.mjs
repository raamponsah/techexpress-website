...
const $$CircularComponents = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<section id="circular-components" class="dark-background astro-C6KWLYQP">
    ...
    <div class="circles-set astro-C6KWLYQP">
     ${renderComponent($$result, "CircleWithText", $$CircleWithText, { "image": "url(../src/images/sam-moghadam-khamseh-baII27W6z7k-unsplash.jpg)", "label": "Quality", "class": "astro-C6KWLYQP" })}
     ${renderComponent($$result, "CircleWithText", $$CircleWithText, { "image": "url(../src/images/milad-fakurian-58Z17lnVS4U-unsplash.jpg)", "label": "Innovation", "class": "astro-C6KWLYQP" })}
     ${renderComponent($$result, "CircleWithText", $$CircleWithText, { "image": "url(../src/images/daniele-franchi-cLxX7ssQfp8-unsplash.jpg)", "label": "Integrity", "class": "astro-C6KWLYQP" })}
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to TechExpress.", "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-J7PV25F6">
	...
	${renderComponent($$result2, "Header", $$Header, { "image": "url(../src/images/sam-moghadam-khamseh-KJ241ZAOYwU-unsplash.jpg)", "mainTitle": "Welcome to Tech", "specialTitle": "Express", "tagline": "We build web/mobile apps that scale at affordable pricing", "class": "astro-J7PV25F6" })}
		...
		<section id="index-services" class="astro-J7PV25F6">
			<div class="section-image astro-J7PV25F6">
				<img${addAttribute(200, "width")}${addAttribute(200, "height")} alt="services-abstract-image"${addAttribute("../src/images/jesse-echevarria-FKs9bUFekHQ-unsplash.jpg", "src")} class="astro-J7PV25F6">
...
const $$Services = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to TechExpress.", "class": "astro-UCD2PS2B" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-UCD2PS2B">
	
	${renderComponent($$result2, "Header", $$Header, { "image": "url(../src/images/milad-fakurian-UYgrVfIhBec-unsplash.jpg)", "mainTitle": "Welcome to Tech", "specialTitle": "Express", "tagline": "We build web/mobile apps that scale at affordable pricing", "class": "astro-UCD2PS2B" })}
		...
		<section class="section astro-UCD2PS2B">
			<div class="section-image astro-UCD2PS2B">
				${renderComponent($$result2, "Image", $$Image, { "width": 150, "height": 220, "alt": "services-abstract-image", "src": "../src/images/radowan-nakif-rehan-cYyqhdbJ9TI-unsplash.jpg", "class": "astro-UCD2PS2B" })}
...
We use modern day cutting-edge technologies to design, develop and deploy your software.
        ...
        <section class="section astro-UCD2PS2B">
			<div class="section-image astro-UCD2PS2B">
				${renderComponent($$result2, "Image", $$Image, { "width": 150, "height": 220, "alt": "services-abstract-image", "src": "../src/images/thom-bradley-A6qNzfJXRGQ-unsplash.jpg", "class": "astro-UCD2PS2B" })}
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to TechExpress.", "class": "astro-KH7BTL4R" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-KH7BTL4R">
	...
	${renderComponent($$result2, "Header", $$Header, { "image": "url(../src/images/tyler-lastovich-3shfnfzdFVc-unsplash.jpg)", "mainTitle": "We are a Software Company", "specialTitle": "", "tagline": "We express your business processes through quality software", "class": "astro-KH7BTL4R" })}
		...
		<section id="who-we-are" class="astro-KH7BTL4R">
            <div class="section-image astro-KH7BTL4R">
                ${renderComponent($$result2, "Image", $$Image, { "width": 200, "height": 382, "alt": "services-abstract-image", "src": "../src/images/andreas-forsberg-R_GN1I76XjM-unsplash.jpg", "class": "astro-KH7BTL4R" })}
            </div>

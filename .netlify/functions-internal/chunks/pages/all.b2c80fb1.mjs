...
import 'html-escaper';
/* empty css                           *//* empty css                              *//* empty css                             */import { jsx, Fragment, jsxs } from 'react/jsx-runtime';
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsxs("form", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("label", {
          for: "date",
          children: "Date and Time for meet"
        }), /* @__PURE__ */ jsx("input", {
          type: "datetime-local",
          name: "date",
          id: "date"
...
__astro_tag_component__(BookingForm, "@astrojs/react");

const $$Astro$2 = createAstro();
const $$Booking = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Booking;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Book: 8Bytes.", "class": "astro-PDFS7TWC" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-PDFS7TWC">
	
	${renderComponent($$result2, "Header", $$Header, { "image": "url(/images/daniele-franchi-cLxX7ssQfp8-unsplash.jpg)", "mainTitle": "Book us today", "specialTitle": "", "tagline": "Transform Your Business with Innovative Software", "class": "astro-PDFS7TWC" })}

		<section class="booking-section astro-PDFS7TWC">
	
			<div class="astro-PDFS7TWC">
				<h3 class="astro-PDFS7TWC">Book a meeting with us</h3>
			<p class="astro-PDFS7TWC">
        ...
        <section id="booking-form" class="astro-PDFS7TWC">
            ${renderComponent($$result2, "BookingForm", BookingForm, { "class": "astro-PDFS7TWC" })}
        </section>


		${renderComponent($$result2, "CircularComponents", $$CircularComponents, { "heading": "Core Values", "class": "astro-PDFS7TWC" })}
		${renderComponent($$result2, "BookSection", $$BookSection, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/raphaelamponsah/Projects/winds/src/components/BookSection.astro", "client:component-export": "default", "class": "astro-PDFS7TWC" })}

	</main>${renderComponent($$result2, "Footer", $$Footer, { "class": "astro-PDFS7TWC" })}` })}`;
}, "/Users/raphaelamponsah/Projects/winds/src/pages/booking.astro");

const $$file$2 = "/Users/raphaelamponsah/Projects/winds/src/pages/booking.astro";
const $$url$2 = "/booking";

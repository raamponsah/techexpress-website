...
import 'html-escaper';
/* empty css                           *//* empty css                              *//* empty css                             *//* empty css                             */import { jsx } from 'react/jsx-runtime';
...
we offer 30 mins free consultation
	...
	${renderComponent($$result, "BookButton", $$BookButton, { "text": "Book a meeting with us", "px": "5px", "py": "5px", "class": "astro-7VINSZ7S" })}
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result, "ResponsiveMenuBtn", $$ResponsiveMenuBtn, { "class": "astro-3EF6KSR2" })}
    ...
    <div class="header-message astro-3EF6KSR2">
        ...
        ${renderComponent($$result, "BookButton", $$BookButton, { "text": "Book a meeting with us", "py": "5px", "px": "5px", "class": "astro-3EF6KSR2" })}
    </div>
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to 8bytes", "class": "astro-J7PV25F6" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-J7PV25F6">
	
	${renderComponent($$result2, "Header", $$Header, { "image": "url(/images/sam-moghadam-khamseh-KJ241ZAOYwU-unsplash.jpg)", "mainTitle": "Welcome to 8bytes", "specialTitle": "", "tagline": "We build web/mobile apps that scale at affordable pricing", "class": "astro-J7PV25F6" })}
		...
		<section id="index-services" class="astro-J7PV25F6">
			<div class="section-image astro-J7PV25F6">
				${renderComponent($$result2, "Image", $$Image, { "width": 200, "height": 220, "alt": "services-abstract-image", "src": "/images/jesse-echevarria-FKs9bUFekHQ-unsplash.jpg", "class": "astro-J7PV25F6" })}
...
const $$Feeback = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Feeback;
  return renderTemplate`${maybeRenderHead($$result)}<p class="astro-CFOY2WFU">Here's an example of a Netlify Form! When you fill this out, the submissions can be found in the Netlify Admin site.</p>
<div class="feedback-form astro-CFOY2WFU">
    <form netlify netlify-honeypot name="feedback" method="POST" action="/success" class="astro-CFOY2WFU">
      <p class="hidden astro-CFOY2WFU">
        <label class="astro-CFOY2WFU">
          Don’t fill this out if you’re human: <input name="bot-field" class="astro-CFOY2WFU">
        </label>
      </p>
      <input type="hidden" name="form-name" value="feedback" class="astro-CFOY2WFU">
      <label for="name" class="astro-CFOY2WFU">Name</label>
      <input id="name" type="text" name="name" class="astro-CFOY2WFU">
      <label for="email" class="astro-CFOY2WFU">Email</label>
      <input id="email" type="email" name="email" required class="astro-CFOY2WFU">
      <label for="feedback" class="astro-CFOY2WFU">What is your feedback?</label>
      <textarea id="feedback" wrap="soft" name="feedback" required class="astro-CFOY2WFU"></textarea>
      <button type="submit" class="astro-CFOY2WFU">Submit</button>
    </form>
</div>`;
...
const $$Contact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Contact;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Book: 8Bytes.", "class": "astro-UW5KDBXL" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-UW5KDBXL">
	
	${renderComponent($$result2, "Header", $$Header, { "image": "url(/images/daniele-franchi-cLxX7ssQfp8-unsplash.jpg)", "mainTitle": "Book us today", "specialTitle": "", "tagline": "Transform Your Business with Innovative Software", "class": "astro-UW5KDBXL" })}

		<section class="booking-section astro-UW5KDBXL">
	
			<div class="astro-UW5KDBXL">
				<h3 class="astro-UW5KDBXL">Book a meeting with us</h3>
        ...
        <section id="booking-form" class="astro-UW5KDBXL">
			${renderComponent($$result2, "Feeback", $$Feeback, { "class": "astro-UW5KDBXL" })}
        </section>


		${renderComponent($$result2, "CircularComponents", $$CircularComponents, { "heading": "Core Values", "class": "astro-UW5KDBXL" })}
		${renderComponent($$result2, "BookSection", $$BookSection, { "class": "astro-UW5KDBXL" })}

	</main>${renderComponent($$result2, "Footer", $$Footer, { "class": "astro-UW5KDBXL" })}` })}`;
...
const $$Success = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Success;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Astro Toolbox", "class": "astro-5Y44LZMC" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<div class="container astro-5Y44LZMC">
        <main class="astro-5Y44LZMC">
          <h1 class="astro-5Y44LZMC">Submission Received!</h1>
          <p class="astro-5Y44LZMC">Thank you for your feedback! Head back to the <a href="/" class="astro-5Y44LZMC">home page</a>.</p>
        </main>
    </div>` })}`;
...
const $$Tnc = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Tnc;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "8bytes Terms and Conditions", "class": "astro-DNNG4RQG" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class="astro-DNNG4RQG">
        <h1 class="astro-DNNG4RQG">TERMS AND CONDITIONS OF USE FOR 8BYTES WEBSITE</h1>

<h3 class="astro-DNNG4RQG">INTRODUCTION</h3>
...
<p class="astro-DNNG4RQG"></p>

<h3 class="astro-DNNG4RQG">
INTELLECTUAL PROPERTY RIGHTS

</h3>
<p class="astro-DNNG4RQG">
...
<h3 class="astro-DNNG4RQG">WEBSITE USE</h3>
<p class="astro-DNNG4RQG">
